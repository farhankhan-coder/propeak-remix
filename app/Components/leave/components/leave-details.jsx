...
import * as leaveApplicationService from "../../../Services/leave-serviceold/leave-service";
          ...
          <div className="col-sm-8">
            <form className=" form-wrapper">
                ...
                <div className="row">
                  <div className="col-sm-12">
                    <div className="form-group">
                      <div className="row">
                        <div className="col-sm-6">
                          <label htmlFor="SelectionOfAction">
                            Selection of action:
                          </label>
                        </div>
                        <div className="col-sm-6">
                          ...
                          {this.state.acceptReject === "approved" ? (
                            <div className="row">
                              <div className="col-sm-6">
                                <label htmlFor="LeaveWithoutApproval">
                              ...
                              <div className="col-sm-6">
                                <input
                                  type="checkbox"
                                  className="form-control"
                                  name="leaveWithoutApproval"
                                  onChange={this.handleCheckBoxChange}
                                  checked={
                                    this.state.leaveDetails.leaveWithoutApproval
                                  }
                                />
                              </div>
                            </div>
                    ...
                    <div className="row">
                      <div className="col-sm-6">
                        <label htmlFor="Reason">
                          ...
                          {this.state.acceptReject === "rejected" ? (
              ...
              <div className="row">
                ...
                <div className="col-sm-6">
                  <Link to="/leave/" className="btn btn-default btn-block">
                    Cancel
                  </Link>
                </div>
              </div>
