...
class LeaveList extends Component {
  ...
  render() {
    ...
    console.log(appliedLeavesResponseForAdmin,allLeavesForCalander,leaves,"applied for Admin ");
  
    let viewList = [];
    if (
      typeof window !== "undefined" &&
      window.propeakConfigData &&
      window.propeakConfigData.calenderViews
    ) {
      ...
      // viewList = window.propeakConfigData.calenderViews.map((module, i) => {
      //   console.log(propeakConfigData, "prrrrrrr");
