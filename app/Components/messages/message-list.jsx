  ...
  async deleteMessage(e, mesgId, allowMessageDelete) {
    if (allowMessageDelete) {
      if (window.confirm("Are you sure you want to delete this message?")) {
        ...
        let response = await messageservice.deleteMessage(
          mesgId,
      ...
      this.state.messages.map((message) => {
        ...
        return (
          <Message
            ...
            key={message._id}
            createdBy={username}
            deleteMessage={this.deleteMessage.bind(this, message._id)}
          />
        );
      });
      ...
      <div>
        <div className="row message-margin">
          <MessageForm
            ...
            addTaskMsg={this.props.addTaskMsg}
          />
        </div>
        <div className="row mt-3 pl-3 pr-2">
          ...
          >
            ...
            <div className="mb-3 mt-3">{messagelist}</div>
            {/* </div> */}
          </div>
        </div>
      </div>
