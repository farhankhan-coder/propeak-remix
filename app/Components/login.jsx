...
import * as userservice from "../routes/login/services/login-service";
...
export class Login extends Component {
  constructor(props) {
    ...
    this.forgotPasswordRequestOnSubmit =
      this.forgotPasswordRequestOnSubmit.bind(this);
  ...
  render() {
    let domainArray = [];
    if (typeof window !== 'undefined' && window.propeakConfigData && window.propeakConfigData.domain) {
