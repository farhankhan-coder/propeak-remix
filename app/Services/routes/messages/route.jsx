...
export default class Message extends React.Component {
  render() {
    ...
    let formattedMessageTitle =
      message.title && message.title.length > 0
        ? message.title
            .split("\n")
            .map((m, index) => (
              <p key={message._id + "_" + index + "_" + m.length}>{m}</p>
            ))
        : "";
    return (
      <React.Fragment>
                  ...
                  <div className="comment-box">
                    <div className="comment-head">
                      ...
                      <i
                        ...
                        onClick={this.props.deleteMessage.bind(
                          this,
                          message._id,
                          allowMessageDelete
                        )}
                    ...
                    <div class="comment-content">{formattedMessageTitle}</div>
                  </div>
                </div>
              </li>
            </ul>
