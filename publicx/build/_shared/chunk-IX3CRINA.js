...
function PrefetchPageLinks({
  ...
  let matches = React.useMemo(() => matchRoutes(router2.routes, page, router2.basename), [router2.routes, page, router2.basename]);
  if (!matches) {
...
function getRouteComponents(route, routeModule, isSpaMode) {
  ...
  if (route.id === "root" && routeModule.Layout) {
    return {
      ...Component2 ? {
        element: /* @__PURE__ */ React4.createElement(routeModule.Layout, null, /* @__PURE__ */ React4.createElement(Component2))
      } : {
        Component: Component2
      },
      ...ErrorBoundary ? {
        errorElement: /* @__PURE__ */ React4.createElement(routeModule.Layout, null, /* @__PURE__ */ React4.createElement(ErrorBoundary))
      } : {
        ErrorBoundary
      },
      ...HydrateFallback ? {
        hydrateFallbackElement: /* @__PURE__ */ React4.createElement(routeModule.Layout, null, /* @__PURE__ */ React4.createElement(HydrateFallback))
      } : {
        HydrateFallback
      }
    };
...
function RemixBrowser(_props) {
  ...
  let [criticalCss, setCriticalCss] = React5.useState(true ? window.__remixContext.criticalCss : void 0);
  if (true) {
...
function ScrollRestoration({
  ...
  return /* @__PURE__ */ React6.createElement("script", _extends({}, props, {
    suppressHydrationWarning: true,
    dangerouslySetInnerHTML: {
...
@remix-run/react/dist/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=/build/_shared/chunk-IX3CRINA.js.map
